...
This directory contains images for the advent calendar doors.
...
- **Style**: Retro gaming aesthetic, bright and colorful
- **Theme**: Christmas/winter festive imagery
- **File size**: Optimize for web (< 200KB per image)

## Placeholder Status

Currently, these are placeholder references. Actual image files need to be added before deployment.
The application will gracefully handle missing images by displaying content without them.
